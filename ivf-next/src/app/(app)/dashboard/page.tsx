  ...
  const displayModules =
    quickAccessModules.length > 0
      ...
      : [
          ...
          { moduleKey: 'cycle_summary', title: 'Cycle Summary', description: 'All cycles taken by the patient', icon: 'cycle', route: '/cycle/summary', colorTheme: 'sky', orderIndex: 3, isPinned: true, isActive: true },
