...
export const SIDE_NAV_SECTIONS: SideNavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Sperm Management', route: '/iui', icon: 'sperm' },
      { label: 'Oocyte Management', route: '/ivf', icon: 'oocyte' },
      { label: 'Embryo Management', route: '/icsi', icon: 'embryo' },
      { label: 'Cryopreservation', route: '/cryo/embryos', icon: 'cryo' },
