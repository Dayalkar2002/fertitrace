...
export const SIDE_NAV_SECTIONS: SideNavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Cycle Creation', route: '/cycle/creation', icon: 'cycle' },
      { label: 'Cycle Retrieval Screen', route: '/cycle/entry', icon: 'cycle' },
...
export const DEFAULT_LEFT_MENUS: LeftMenuItem[] = [
  ...
  { nodeId: 20, nodeName: 'consent_forms', label: 'Consent Form', route: '/consent', icon: 'consent', orderIndex: 11, isActive: false },
  {
    ...
    isActive: true,
    subModules: [
      { nodeId: 111, nodeName: 'patient_messages', label: 'Patient Messages', route: '/communication', icon: 'communication', orderIndex: 1, isActive: true },
      { nodeId: 112, nodeName: 'internal_alarms', label: 'Internal Alarms', route: '/communication?tab=alarms', icon: 'communication', orderIndex: 2, isActive: true },
    ],
  },
